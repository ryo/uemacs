...
#define KEYPAD	0		/* (VMS) - turn on application keypad */
#define XONDATA	0		/* VMS only - set to force /NOTTSYNC/NOHOSTSY */
#define	RMSIO	0		/* on VMS, skip the rotten C runtime  	*/
				/* and use RMS directly			*/
#define OPTMEM	0		/* on systems such as VMS, use a less standard*/
...
#define ASCII7BITS 0	/* to display 8-bit char as \xxx -jpr-		*/
...
#if	MSDOS | OS2 | V7 | USG | SMOS | HPUX | BSD | (ST520 & MWC) | WMCS
#define	ENVFUNC	1
#else
#define ENVFUNC 0
#endif
...
#define KRSIZE  8			/* Num items in kill ring PGA   */
...
/*********************************************************************/
/* The kill ring is an array of KILLRING structures.  up to a max of */
/* KRSIZE items may be in the ring at any one time.                  */
/*********************************************************************/
...
#define MC_GRPBEG	'{'	/* Start of group.*/
#define MC_GRPEND	'}'	/* End of group.*/
