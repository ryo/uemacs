...
#include	"estruct.h"
#include	"eproto.h"
#if	V7 | BSD | USG | SMOS | HPUX | SUN | XENIX
#include        "edef.h"
#include	"elang.h"

#if	USG | SMOS | HPUX | SUN | XENIX			/* System V */
#include	<signal.h>
#include	<termio.h>
#include	<fcntl.h>
#include	<ndir.h>
...
#if	HPUX
 	ntermio.c_iflag = otermio.c_iflag & IENQAK;	/* setup new settings */
#else
...
ttputc(c)
{
#if     V7 | USG | SMOS | HPUX | SUN | XENIX | BSD
        fputc(c, stdout);
#endif
}
...
#if	TERMCAP & (USG | SMOS | HPUX | SUN | XENIX)
