...
*??????	-----	__HSTA
*	ds.b	_HEAP_SIZE
*??????	-----	_environ		* 環境変数はここへ移動 by SALT  1991 10/12(Sat)
*	ds.b	envlen			*
*	ds.b	envlen			*
...
*	child & level 2 mem管理
	...
	.text
	dc.b	'C library for X68000 XCｺﾝﾊﾟｲﾗ v1.00',0
...
*	ヒープ領域の初期化		* deleted by SALT  1991 10/11(Fri)
	move.l	__HSTA,a0
	move.l	a0,MALLOCP
	lea	16(a0),a1
	clr.l	(a0)+
