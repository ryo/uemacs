...
NBIND command_table[] = {
	...
	{NULL,	"keyword-complete",				keyword_complete,		QVIEW},
	...
	{NULL,	"load-cfont-6x12",				loadcfont_6x12,			0},
	{NULL,	"load-emphasis-data",			loadempdata,			0},
	{NULL,	"load-font",					loadfont,				0},
	{NULL,	"load-font-half",				loadfont_h,				0},
	{NULL,	"load-font-6x12",				loadfont_6x12,			0},
	{NULL,	"look-up-word",					lookupword,				0},
