...
UENVAR env_table[] = {
	...
	{NULL,	"ccase-latex",			EVCCASELATEX,		&compcase[5]},
	{NULL,	"ccase-macro",			EVCCASEMAC,			&compcase[6]},
	{NULL,	"ccase-mode",			EVCCASEMODE,		&compcase[7]},
	{NULL,	"ccase-var",			EVCCASEVAR,			&compcase[8]},
	...
	{NULL,	"quickact-macro",		EVQUICKACTMAC,		&quickact[6]},
	{NULL,	"quickact-mode",		EVQUICKACTMODE,		&quickact[7]},
	{NULL,	"quickact-var",			EVQUICKACTVAR,		&quickact[8]},
