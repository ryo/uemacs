...
extern BITMAP PASCAL NEAR clearbits(void);
...
extern char *PASCAL NEAR getreg(void);
...
extern PASCAL NEAR bktoshell(int f, int n);	/* added BD	*/
...
extern PASCAL NEAR debug(BUFFER *bp, char *eline);
...
extern PASCAL NEAR kinsert(char c);
...
extern PASCAL NEAR mcclear(void);
...
extern PASCAL NEAR rmcclear(void);
extern PASCAL NEAR rvstrcpy(char *rvstr, char *str);
extern PASCAL NEAR savewnd(int f, int n);
extern PASCAL NEAR scwrite(int row, char *outstr, int forg, int bacg);
extern PASCAL NEAR setbit(int bc, BITMAP cclmap);
...
extern PASCAL NEAR setjtable(void);
...
extern WINDOW *PASCAL NEAR wpopup(void);
...
extern BITMAP PASCAL NEAR clearbits();
...
extern PASCAL NEAR bktoshell();	/* added BD	*/
...
extern WINDOW *PASCAL NEAR wpopup();

/* Amaranth's extensions */
extern PASCAL NEAR dispklist();        
extern PASCAL NEAR fresearch();        
extern PASCAL NEAR rresearch();        
extern PASCAL NEAR twidlword();        
extern PASCAL NEAR twidlines();        
extern PASCAL NEAR yankprev();        
extern PASCAL NEAR wipenyank();        
extern PASCAL NEAR indxkr();        
extern PASCAL NEAR space();    
#if	CTAGS
